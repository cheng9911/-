...
{   
	...
	ros::NodeHandle n; 
	ros::Publisher sendcommand_pub = n.advertise<std_msgs::Float64MultiArray>("coordinate", 1); 
    ...
    while (inputVideo.grab()) 
    {
        ...
        vector<double> send_command(3,0);
        send_command[0] = tvecs[0][0]*10;
        send_command[1] = tvecs[0][1]*10;
        send_command[2] = tvecs[0][2]*10;
        msg.data=send_command;
